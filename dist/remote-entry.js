...
import { g, a, b, d, s } from "./chunks/event-state.js";
import { c as c2, g as g$1, p, r } from "./chunks/query.js";
      ...
      if (!state.prerendering && !D && !event.isRemoteRequest) {
        try {
          return await g$1(id, arg, event, async () => {
            ...
            (state.remote_data ?? (state.remote_data = {}))[d(id, payload)] = prerendered.result;
